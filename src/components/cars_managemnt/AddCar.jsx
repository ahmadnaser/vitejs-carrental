...
const AddCarForm = () => {
  ...
  const validateForm = () => {
    const errors = {};
    if (!formData.carMake) errors.carMake = t('Car make is required');
    if (!formData.carName) errors.carName = t('Car name is required');
    if (!formData.year) errors.year = t('Year of production is required');
    if (!formData.plateNumber) errors.plateNumber = t('Plate number is required');
    if (!formData.color) errors.color = t('Color is required');
    if (!formData.mileage) errors.mileage = t('Mileage is required');
    if (!formData.lastOilChangeMiles) errors.lastOilChangeMiles = t('Last oil change miles is required');
    if (!formData.lastOilChangeDate) errors.lastOilChangeDate = t('Last oil change date is required');
    if (!formData.dateOfLicense) errors.dateOfLicense = t('Date of license is required');
    if (!formData.endDateOfLicense) errors.endDateOfLicense = t('End date of license is required');
    if (!formData.dateOfInsurance) errors.dateOfInsurance = t('Date of insurance is required');
    if (!formData.endDateOfInsurance) errors.endDateOfInsurance = t('End date of insurance is required');
    if (!formData.changeOilKm) errors.changeOilKm = t('Change oil every (km) is required');
    if (!formData.changeOilMonth) errors.changeOilMonth = t('Change oil every (month) is required');
