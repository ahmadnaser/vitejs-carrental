...
const GarageStatement = ({ data, startDate, endDate, garageName }) => {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={styles.tableRow}>
            ...
            <Text style={styles.tableColHeader}>الصيانة</Text>
          ...
          {data.map((maintenanceData, index) => {
            const totalAmount = parseFloat(maintenanceData.cost) || 0;
            const amountPaid = parseFloat(maintenanceData.amount_paid) || 0;
            ...
            return (
              <View key={index} style={styles.tableRow}>
                ...
                <Text style={styles.tableCol}>{maintenanceData.details}</Text>
...
export default GarageStatement;
